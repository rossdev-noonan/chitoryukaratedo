...
export function GlobalCommunityCTA({ lang }: GlobalCommunityCTAProps) {
  return (
    <section className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-0">
      <div className="bg-primary-dark flex min-h-[199px] flex-col items-start justify-center gap-8 px-6 py-12 sm:flex-row sm:items-center sm:justify-between sm:px-10 lg:px-20 lg:py-16">
        <div>
