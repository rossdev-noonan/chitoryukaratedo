      ...
      <div className="relative mx-auto w-full max-w-[1440px] overflow-hidden">
        ...
        <div className="bg-background hidden px-10 pt-12 pb-8 md:block xl:hidden">
          <div className="flex h-[272px] flex-col items-start">
            <p className="public-hero-breadcrumb text-brand-accent font-semibold uppercase">
              home / about / history
            </p>
            <div className="bg-primary mt-[11px] h-[3px] w-[86px]" />
            <h1 className="public-hero-title font-heading mt-[11px] font-semibold text-[#1f2937]">
        ...
        <div className="relative hidden h-[720px] w-full overflow-hidden xl:block">
          <div className="absolute inset-y-0 right-0 w-full xl:left-[34.8%] xl:w-[65.2%]">
            <Image
              ...
              alt="Aerial view of Chito-Ryu practitioners in formation before a ceremonial hall"
              fill
              sizes="(min-width: 1440px) 939px, (min-width: 1280px) 66vw, 100vw"
        ...
        <div className="bg-background relative px-5 py-8 md:hidden xl:absolute xl:inset-0 xl:block xl:bg-transparent xl:px-20 xl:pt-[120px]">
          <div className="relative xl:w-[630px]">
            ...
            <h1 className="public-hero-title font-heading mt-3 hidden font-semibold text-[#1f2937] xl:block">
              A thousand years,
              <br />
              one lineage.
            </h1>
