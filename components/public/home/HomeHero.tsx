...
export function HomeHero({ lang, dictionary }: HomeHeroProps) {
  ...
  return (
    <section className="relative overflow-hidden md:h-[406px] lg:h-[720px]">
      {/* The texture remains full bleed on wide screens; only the foreground
          composition is constrained to the original 1440px Figma canvas. */}
      <motion.div
        aria-hidden
      ...
      <div className="relative mx-auto w-full max-w-[1440px] md:h-full">
        <div className="relative isolate h-[280px] w-full overflow-hidden sm:h-[360px] md:absolute md:inset-0 md:h-full">
          ...
          <div className="absolute top-0 right-0 aspect-[1440/720] h-full md:-right-[39px] lg:right-0">
          ...
          <div className="relative md:w-[480px] lg:w-[720px] lg:max-w-[50vw]">
            <AnimatePresence mode="wait">
              <motion.div
                ...
                exit={{ opacity: 0, transition: { duration: 0.35, ease: "easeIn" } }}
                transition={{
                  delay: activeSlide === 0 ? 0.16 : 0.1,
                  duration: 0.56,
                  ease: easeOutExpo,
                }}
              >
                <h1 className="public-hero-title font-heading text-2xl leading-normal font-medium md:w-[480px] lg:w-[720px]">
